...
/*:
 ...
 Raw strings allow you to use backlashes too:
*/
    let keypaths = #"Swift keypaths such as \Person.name hold uninvoked references to properties."#
/*:
 That treats the backlash as being a literal character in the string, rather than an escape character. This in turn means that string interpolation works differently:
*/
    let answer = 42
...
/*:
 Thanks to raw strings we can write the same thing with half the number of backlashes:
*/
